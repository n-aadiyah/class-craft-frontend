      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-4 sm:p-6 border border-gray-100">
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <img
                  ...
                  alt="Profile"
                  className="w-20 h-20 sm:w-16 sm:h-16 rounded-full object-cover border shadow-sm"
                />

                <label className="cursor-pointer bg-red-700 text-white flex items-center gap-2 px-3 py-2 sm:py-1.5 rounded-lg text-sm hover:bg-red-800 transition w-full sm:w-auto justify-center sm:justify-start">
                  <Upload size={16} />
                  <span>Upload</span>
                  <input
                    type="file"
            ...
            {/* Save Button */}
            <button className="w-full bg-red-700 text-white py-2.5 rounded-lg font-medium hover:bg-red-800 transition text-sm sm:text-base">
              Save Profile
            </button>
          </div>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-4 sm:p-6 border border-gray-100">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
            <SunMoon size={18} className="text-red-700" />
            Preferences
          </h2>
          ...
          <div className="mt-10 border-t pt-6">
            ...
            <div className="flex flex-col gap-3">
              <button className="w-full bg-yellow-500 text-white py-2.5 rounded-lg font-medium hover:bg-yellow-600 transition text-sm sm:text-base">
                Change Password
              </button>
              <button className="w-full bg-red-700 text-white py-2.5 rounded-lg font-medium hover:bg-red-800 transition text-sm sm:text-base">
                Delete Account
